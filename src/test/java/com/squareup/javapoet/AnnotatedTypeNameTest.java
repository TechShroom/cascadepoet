...
public class AnnotatedTypeNameTest {
    ...
    public void annotated() {
        ...
        TypeName annotated = simpleString.annotated(this.NEVER_NULL);
    ...
    public void annotatedTwice() {
        ...
        TypeName type = TypeName.get(String.class);
        String actual =
                type.annotated(this.NEVER_NULL).annotated(AnnotationSpec.builder(Override.class).build()).toString();
        assertEquals(expected, actual);
    }
    ...
    public void annotatedArgumentOfParameterizedType() {
        ...
        TypeName type = TypeName.get(String.class).annotated(this.NEVER_NULL);
    ...
    private void annotatedEquivalence(TypeName type) {
        ...
        assertEquals(type.annotated(this.NEVER_NULL), type.annotated(this.NEVER_NULL));
        assertNotEquals(type, type.annotated(this.NEVER_NULL));
        assertEquals(type.hashCode(), type.hashCode());
        assertEquals(type.annotated(this.NEVER_NULL).hashCode(), type.annotated(this.NEVER_NULL).hashCode());
        assertNotEquals(type.hashCode(), type.annotated(this.NEVER_NULL).hashCode());
    }
