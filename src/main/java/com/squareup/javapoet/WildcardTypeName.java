...
public final class WildcardTypeName extends TypeName {
    ...
    CodeWriter emit(CodeWriter out) throws IOException {
        ...
        return this.upperBounds.get(0).equals(TypeName.OBJECT) ? out.emit("?")
                : out.emit("? extends $T", this.upperBounds.get(0));
    }
    ...
    static TypeName
            get(javax.lang.model.type.WildcardType mirror, Map<TypeParameterElement, TypeVariableName> typeVariables) {
